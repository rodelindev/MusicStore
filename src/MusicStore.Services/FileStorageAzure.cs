...
public class FileStorageAzure(
    ILogger<FileStorageAzure> logger,
    IConfiguration configuration
) : IFileStorage
{
    private readonly string azureConnectionString = configuration.GetConnectionString("azureStorage") ?? string.Empty;
